...
public class ShooterConstants {
    ...
    public static final double HOOD_MIN_ANGLE_LIMIT = 0.6;
    public static final double HOOD_MAX_ANGLE_LIMIT = 1.07;
    public static final Gains FLYWHEEL_GAINS = new Gains(0,0,0,0, 0.1875, 0, 0);
