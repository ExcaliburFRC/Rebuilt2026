...
public class ShooterConstants {
    ...
    public static final double FLYWHEEL_TOLERANCE = 0.9
            ;
...
//    public static final Gains FLYWHEEL_GAINS = new Gains();
    ...
    public static final Gains HOOD_PID_GAINS = new Gains(8.1, 0, 0, 0.425, 0, 0, 0);
//    public static final Gains HOOD_PID_GAINS = new Gains();

    // ===== Transport Constants =====
    public static final Gains TRANSPORT_PID_GAINS = new Gains(0.05,0,0,0.4,0.1,0,0);
