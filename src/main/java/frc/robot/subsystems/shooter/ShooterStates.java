...
public enum ShooterStates {
    ...
    SHOOT_FAR_DELIVERY(DELIVERY_LEFT_POSE.get().getTranslation(), LOW, true),
    LOOK_FAR_DELIVERY(DELIVERY_LEFT_POSE.get().getTranslation(), LOW, false),
    SHOOT_CLOSE_DELIVERY(DELIVERY_RIGHT_POSE.get().getTranslation(), LOW, true),
    LOOK_CLOSE_DELIVERY(DELIVERY_RIGHT_POSE.get().getTranslation(), LOW, false),
